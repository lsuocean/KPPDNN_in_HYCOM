...
!
      ...
      call blkini(hsblmt,'hsblmt')
#if defined KPP_DNN
      call blkini(dnnflg,'dnnflg')

      ! Load DNN weights
      if (dnnflg.eq.1) then   
        ! DNN_NW
        f_eta = '/project/ocean/fourones/dnn_param/eta_nnw.txt'
        f_eta0 = '/project/ocean/fourones/dnn_param/eta0_nnw.txt'
        f_epsl = '/project/ocean/fourones/dnn_param/epsl_nnw.txt'
        f_mean = '/project/ocean/fourones/dnn_param/mean_nnw.txt'
        f_sd = '/project/ocean/fourones/dnn_param/sd_nnw.txt'
      else if (dnnflg.eq.2) then
        ! DNN_WV
        f_eta = '/project/ocean/fourones/dnn_param/eta_nwv.txt'
        f_eta0 = '/project/ocean/fourones/dnn_param/eta0_nwv.txt'
        f_epsl = '/project/ocean/fourones/dnn_param/epsl_nwv.txt'
        f_mean = '/project/ocean/fourones/dnn_param/mean_nwv.txt'
        f_sd = '/project/ocean/fourones/dnn_param/sd_nwv.txt'
      endif

      call model_eta0 % load(trim(f_eta0))
      call model_epsl % load(trim(f_epsl))
      call model_eta % load(trim(f_eta))
